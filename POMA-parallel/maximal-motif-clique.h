...
void GetCandidates(const set<int> &current_node_set, const int new_node, const map<int, map<int, set<int>>> &label2adj,
                   const unordered_set<int> &candidates, map<int,  set<int>> &label2cover, const Graph &mitif, const Graph &graph, const set<int> &NOT,
                   set<int> &NOT_new,
...
void UsePivotPruning(const set<int> &NOT, const set<int> current_node_set_th, const unordered_set<int> &candidates_th, const map<int, map<int, set<int>>> label2adj_th, map<int,  set<int>> label2cover_th, unordered_set<int> &candidates_copy, int choice);
